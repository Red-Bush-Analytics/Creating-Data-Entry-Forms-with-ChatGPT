...
Do it right the first time, even for a small project? Create a SQL database using appropriate software, it a bit of work but your life will be easier in the long run.<br>
...
What you can do, the number of prompts, amount of input data you can use and type of result will depend on your subscription level (Free,Plus, Pro).
